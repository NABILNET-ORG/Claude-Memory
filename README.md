...
* [DONE] [OBS-EPIC] system_dashboard MCP tool (unified read API) (archived at 2026-05-13).
* [DONE] [OBS-EPIC] Health derivations + alert thresholds in check_system_health (archived at 2026-05-13).
### 🚀 Recent Progress
...
_Auto-synced at 2026-05-13T13:23:11.680Z for `smart-claude-memory`._
...
flowchart TD
  ...
  n23["plans/"]
  n22 --> n23
  n24["2026-05-12-observability-telemetry.md"]
  n23 --> n24
  n25["IDE-INTEGRATION.md"]
  n2 --> n25
  n26["NEXT-SESSION-PROMPT.md"]
  n2 --> n26
  n27["hooks/"]
  n0 --> n27
  n28["md-policy.py"]
  ...
  n30["images/"]
  n0 --> n30
  n31["GPT SMC v2.0-rc1.png"]
  n30 --> n31
  n32["scripts/"]
  n0 --> n32
  n33["001_schema.sql"]
  n32 --> n33
  n34["002_multi_project.sql"]
  n32 --> n34
  n35["003_file_hash.sql"]
  n32 --> n35
  n36["004_backlog_frozen.sql"]
  n32 --> n36
  n37["005_archive_backlog.sql"]
  n32 --> n37
  n38["006_security_hardening.sql"]
  n32 --> n38
  n39["006_smoke.sql"]
  n32 --> n39
  n40["006_verify.sql"]
  n32 --> n40
  n41["007_metadata_typed_retrieval.sql"]
  n32 --> n41
  n42["008_global_scope.sql"]
  n32 --> n42
  n43["009_fix_rpc_dual_scope.sql"]
  n32 --> n43
  n44["010_agent_skills.sql"]
  n32 --> n44
  n45["011_trajectory_compaction.sql"]
  n32 --> n45
  n46["012_sleep_learning.sql"]
  n32 --> n46
  n47["013_archive_backlog_chunk_link.sql"]
  n32 --> n47
  n48["014_workflow_checkpoints.sql"]
  n32 --> n48
  n49["015_curriculum_tasks.sql"]
  n32 --> n49
  n50["016_daemon_telemetry.sql"]
  n32 --> n50
  n51["017_explicit_service_role_grants.sql"]
  n32 --> n51
  n52["apply-schema.ts"]
  n32 --> n52
  n53["backup-and-remove.ts"]
  n32 --> n53
  n54["e2e-incremental-test.ts"]
  n32 --> n54
  n55["e2e-isolation-test.ts"]
  n32 --> n55
  n56["e2e-test.ts"]
  n32 --> n56
  n57["lint-boundaries.ts"]
  n32 --> n57
  n58["… (18 more)"]
  n32 --> n58
  n59["src/"]
  ...
  n88["sleep.ts"]
  n69 --> n88
  n89["sovereign-constitution.ts"]
  n69 --> n89
  n90["summarize.ts"]
  n69 --> n90
  n91["sync.ts"]
  n69 --> n91
  n92["system_dashboard.ts"]
  n69 --> n92
  n93["verification.ts"]
  n69 --> n93
  n94["trajectory/"]
  ...
  n103["ollama.ts"]
  n59 --> n103
  n104["project-detect.ts"]
  n59 --> n104
  n105["project.ts"]
  n59 --> n105
  n106["supabase.ts"]
  n59 --> n106
  n107["verification-gate.ts"]
  n59 --> n107
  n108["version.ts"]
  n59 --> n108
  n109["tests/"]
  n0 --> n109
  n110["trajectory-daemon.test.ts"]
  n109 --> n110
  n111["trajectory-stripper.test.ts"]
  n109 --> n111
  n112["trajectory-summarizer.test.ts"]
  n109 --> n112
  n113[".env.example"]
  n0 --> n113
  n114[".gitignore"]
  n0 --> n114
  n115["ARCHITECTURE.md"]
  n0 --> n115
  n116["CLAUDE.md"]
  n0 --> n116
  n117["LICENSE"]
  n0 --> n117
  n118["package-lock.json"]
  n0 --> n118
  n119["package.json"]
  n0 --> n119
  n120["project_file_architecture.md"]
  n0 --> n120
  n121["README.md"]
  n0 --> n121
  n122["tsconfig.json"]
