...
_Auto-synced at 2026-05-18T11:08:43.840Z for `smart-claude-memory`._
...
flowchart TD
  ...
  n76["apply-schema.ts"]
  n56 --> n76
  n77["backfill-ledger.ts"]
  n56 --> n77
  n78["backup-and-remove.ts"]
  n56 --> n78
  n79["e2e-incremental-test.ts"]
  n56 --> n79
  n80["e2e-isolation-test.ts"]
  n56 --> n80
  n81["e2e-test.ts"]
  n56 --> n81
  n82["… (25 more)"]
  ...
  n110["image.ts"]
  n98 --> n110
  n111["list-global-patterns.ts"]
  n98 --> n111
  n112["orchestrator.ts"]
  n98 --> n112
  n113["policy.ts"]
  n98 --> n113
  n114["prune.ts"]
  ...
  n118["setup.ts"]
  n98 --> n118
  n119["shared-schemas.ts"]
  n98 --> n119
  n120["skills.ts"]
  n98 --> n120
  n121["sleep.ts"]
  n98 --> n121
  n122["sovereign-constitution.ts"]
  n98 --> n122
  n123["summarize.ts"]
  n98 --> n123
  n124["… (3 more)"]
  ...
  n134["ollama.ts"]
  n83 --> n134
  n135["project-detect.ts"]
  n83 --> n135
  n136["project.ts"]
  n83 --> n136
  n137["supabase.ts"]
  n83 --> n137
  n138["verification-gate.ts"]
  n83 --> n138
  n139["version.ts"]
  n83 --> n139
  n140["tests/"]
  ...
  n146["006_verify.sql"]
  n144 --> n146
  n147["capabilities.test.ts"]
  n140 --> n147
  n148["checkpoint.test.ts"]
  n140 --> n148
  n149["curriculum-consumer.test.ts"]
  n140 --> n149
  n150["curriculum-scanner.test.ts"]
  n140 --> n150
  n151["graduation-handlers.test.ts"]
  n140 --> n151
  n152["graduation-scanner.test.ts"]
  n140 --> n152
  n153["health.test.ts"]
  n140 --> n153
  n154["list-global-patterns.test.ts"]
  n140 --> n154
  n155["migrations.test.ts"]
  n140 --> n155
  n156["orchestrator.test.ts"]
  n140 --> n156
  n157["prune.test.ts"]
  n140 --> n157
  n158["trajectory-daemon.test.ts"]
  n140 --> n158
  n159["trajectory-stripper.test.ts"]
  n140 --> n159
  n160["trajectory-summarizer.test.ts"]
  n140 --> n160
  n161[".env.example"]
  n0 --> n161
  n162[".gitignore"]
  n0 --> n162
  n163["ARCHITECTURE.md"]
  n0 --> n163
  n164["CHANGELOG.md"]
  n0 --> n164
  n165["CLAUDE.md"]
  ...
  n166["LICENSE"]
  n0 --> n166
  n167["marketplace.json"]
  n0 --> n167
  n168["package-lock.json"]
  n0 --> n168
  n169["package.json"]
  n0 --> n169
  n170["project_file_architecture.md"]
  n0 --> n170
  n171["README.md"]
  n0 --> n171
  n172["tsconfig.json"]
