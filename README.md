...
_Auto-synced at 2026-05-18T13:48:36.997Z for `smart-claude-memory`._
...
flowchart TD
  ...
  n121["kg.ts"]
  n108 --> n121
  n122["list-global-patterns.ts"]
  n108 --> n122
  n123["orchestrator.ts"]
  n108 --> n123
  n124["policy.ts"]
  n108 --> n124
  n125["prune.ts"]
  ...
  n129["setup.ts"]
  n108 --> n129
  n130["shared-schemas.ts"]
  n108 --> n130
  n131["skills.ts"]
  n108 --> n131
  n132["sleep.ts"]
  n108 --> n132
  n133["sovereign-constitution.ts"]
  n108 --> n133
  n134["… (4 more)"]
  n108 --> n134
  n135["trajectory/"]
  ...
  n144["ollama.ts"]
  n89 --> n144
  n145["project-detect.ts"]
  n89 --> n145
  n146["project.ts"]
  n89 --> n146
  n147["supabase.ts"]
  n89 --> n147
  n148["verification-gate.ts"]
  n89 --> n148
  n149["version.ts"]
  n89 --> n149
  n150["tests/"]
  ...
  n156["006_verify.sql"]
  n154 --> n156
  n157["capabilities.test.ts"]
  n150 --> n157
  n158["checkpoint.test.ts"]
  n150 --> n158
  n159["curriculum-consumer.test.ts"]
  n150 --> n159
  n160["curriculum-scanner.test.ts"]
  n150 --> n160
  n161["graduation-daemon.test.ts"]
  n150 --> n161
  n162["graduation-handlers.test.ts"]
  n150 --> n162
  n163["graduation-scanner.test.ts"]
  n150 --> n163
  n164["gui.test.ts"]
  n150 --> n164
  n165["health.test.ts"]
  ...
  n166["kg.test.ts"]
  n150 --> n166
  n167["list-global-patterns.test.ts"]
  n150 --> n167
  n168["migrations.test.ts"]
  n150 --> n168
  n169["orchestrator.test.ts"]
  n150 --> n169
  n170["prune.test.ts"]
  n150 --> n170
  n171["trajectory-daemon.test.ts"]
  n150 --> n171
  n172["trajectory-stripper.test.ts"]
  n150 --> n172
  n173["trajectory-summarizer.test.ts"]
  n150 --> n173
  n174[".env.example"]
  n0 --> n174
  n175[".gitignore"]
  n0 --> n175
  n176["ARCHITECTURE.md"]
  n0 --> n176
  n177["CHANGELOG.md"]
  n0 --> n177
  n178["CLAUDE.md"]
  ...
  n179["LICENSE"]
  n0 --> n179
  n180["marketplace.json"]
  n0 --> n180
  n181["package-lock.json"]
  n0 --> n181
  n182["package.json"]
  n0 --> n182
  n183["project_file_architecture.md"]
  n0 --> n183
  n184["README.md"]
  n0 --> n184
  n185["tsconfig.json"]
